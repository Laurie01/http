...
public final class ActivityProductBinding implements ViewBinding {
  ...
  @NonNull
  public final ListView ourListView;

  @NonNull
  public final Toolbar toolbar;

  private ActivityProductBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton fab, @NonNull ListView ourListView, @NonNull Toolbar toolbar) {
    this.rootView = rootView;
    this.fab = fab;
    this.ourListView = ourListView;
  ...
  public static ActivityProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ourListView;
      ListView ourListView = ViewBindings.findChildViewById(rootView, id);
      if (ourListView == null) {
        break missingId;
      }
      ...
      return new ActivityProductBinding((CoordinatorLayout) rootView, fab, ourListView, toolbar);
    }
